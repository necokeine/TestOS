...
00000000 <.stabstr>:
   ...
   6:	63 63 41             	arpl   %sp,0x41(%ebx)
   9:	53                   	push   %ebx
   a:	39 79 36             	cmp    %edi,0x36(%ecx)
   d:	38 2e                	cmp    %ch,(%esi)
